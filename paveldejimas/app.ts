abstract class Gyvunas {
  constructor(protected _vardas: string, protected _amzius: number) {}
...
class Suo extends Gyvunas {
  constructor(vardas: string, amzius: number, protected _veisle: string) {
    super(vardas, amzius);
  }
...
class DulkiuSiurblys implements GarsoSkleidikai {
  constructor(private _gamintojas: string, public decibelai: number) {}
